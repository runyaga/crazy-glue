...
Find the largest file in a directory and its descendants.
"""
...
class BigFileResult(pydantic.BaseModel):
    """Structured result for big_file tool."""
...
async def big_file(path: str = ".") -> BigFileResult:
    """
    ...
    Returns:
        BigFileResult: The largest file path and its size.
    """
    try:
